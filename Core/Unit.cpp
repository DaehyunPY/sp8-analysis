...
const double Analysis::Unit::kFineStructureConstant = 7.297352566417e-3;
const double Analysis::Unit::kBohrRadius = 5.291772109217e-11;
const double Analysis::Unit::kHartreeEnergy = 4.35974465054e-18;
...
const double Analysis::Unit::kGauss = 1.e-4;
const double Analysis::Unit::kNano = 1.e-9;
const double Analysis::Unit::kMilli = 1.e-3;
